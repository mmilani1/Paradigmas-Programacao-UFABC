...
/* package cifra-0.1.0.0 */
#ifndef VERSION_cifra
#define VERSION_cifra "0.1.0.0"
#endif /* VERSION_cifra */
#ifndef MIN_VERSION_cifra
#define MIN_VERSION_cifra(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_cifra */
...
#define CURRENT_COMPONENT_ID "cifra-0.1.0.0-CiuCoHeKXVbDSCSVlM9gkU-cifra"
