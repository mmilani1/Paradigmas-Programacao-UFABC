...
/* package recur-0.1.0.0 */
#ifndef VERSION_recur
#define VERSION_recur "0.1.0.0"
#endif /* VERSION_recur */
#ifndef MIN_VERSION_recur
#define MIN_VERSION_recur(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_recur */
...
#define CURRENT_COMPONENT_ID "recur-0.1.0.0-LMg0TTGHCFNDFCZGyNQWYY-recur"
